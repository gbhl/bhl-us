...
{	
	...
	public abstract class __OAIRecordCreator : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		...
		/// </summary>
		[ColumnDefinition("Dates", DbTargetType=SqlDbType.NVarChar, Ordinal=4, CharacterMaxLength=50)]
		public string Dates
		{
			get
			{
		...
		/// </summary>
		[ColumnDefinition("ProductionAuthorID", DbTargetType=SqlDbType.Int, Ordinal=5, NumericPrecision=10, IsNullable=true)]
