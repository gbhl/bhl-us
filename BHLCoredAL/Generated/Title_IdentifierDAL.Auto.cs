...
// This partial class Title_IdentifierDAL is based upon Title_Identifier.
...
namespace MOBOT.BHL.DAL
{
	partial class Title_IdentifierDAL 
	{
		...
		/// <summary>
		/// Select values from Title_Identifier by primary key(s).
		/// </summary>
		...
		public CustomGenericList<CustomDataRow> Title_IdentifierSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int titleIdentifierID)
		{
		...
		/// <summary>
		/// Insert values into Title_Identifier.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Insert values into Title_Identifier. Returns an object of type Title_Identifier.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from Title_Identifier by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="titleIdentifierID"></param>
		...
		/// <summary>
		/// Update values in Title_Identifier. Returns an object of type Title_Identifier.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="titleIdentifierID"></param>
		...
		/// <summary>
		/// Manage Title_Identifier object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in Title_Identifier.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type Title_Identifier.</param>
