...
// This partial class NameSourceDAL is based upon NameSource.
...
namespace MOBOT.BHL.DAL
{
	partial class NameSourceDAL 
	{
		...
		/// <summary>
		/// Select values from NameSource by primary key(s).
		/// </summary>
			...
			int nameSourceID )
		{
				...
				CustomSqlHelper.CreateInputParameter("NameSourceID", SqlDbType.Int, null, false, nameSourceID)))
			{
				...
				{
					CustomGenericList<NameSource> list = helper.ExecuteReader(command);
					if (list.Count > 0)
					{
						NameSource o = list[0];
						list = null;
		...
		public CustomGenericList<CustomDataRow> NameSourceSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int nameSourceID)
		{
		...
		/// <summary>
		/// Insert values into NameSource. Returns an object of type NameSource.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from NameSource by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="nameSourceID"></param>
		...
		/// <summary>
		/// Update values in NameSource. Returns an object of type NameSource.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="nameSourceID"></param>
		...
		/// <summary>
		/// Manage NameSource object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in NameSource.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type NameSource.</param>
