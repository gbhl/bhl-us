...
// This partial class SegmentResolutionLogDAL is based upon SegmentResolutionLog.
...
namespace MOBOT.BHL.DAL
{
	partial class SegmentResolutionLogDAL 
	{
		...
		/// <summary>
		/// Select values from SegmentResolutionLog by primary key(s).
		/// </summary>
			...
			int segmentResolutionLogID )
		{
				...
				CustomSqlHelper.CreateInputParameter("SegmentResolutionLogID", SqlDbType.Int, null, false, segmentResolutionLogID)))
			{
				...
				{
					CustomGenericList<SegmentResolutionLog> list = helper.ExecuteReader(command);
					if (list.Count > 0)
					{
		...
		public CustomGenericList<CustomDataRow> SegmentResolutionLogSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int segmentResolutionLogID)
		{
		...
		/// <summary>
		/// Insert values into SegmentResolutionLog.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Insert values into SegmentResolutionLog. Returns an object of type SegmentResolutionLog.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from SegmentResolutionLog by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="segmentResolutionLogID"></param>
		...
		/// <summary>
		/// Update values in SegmentResolutionLog. Returns an object of type SegmentResolutionLog.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="segmentResolutionLogID"></param>
		...
		/// <summary>
		/// Manage SegmentResolutionLog object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in SegmentResolutionLog.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type SegmentResolutionLog.</param>
