...
namespace MOBOT.BHL.DAL
{
	partial class SegmentClusterDAL 
	{
		...
		/// <summary>
		/// Select values from SegmentCluster by primary key(s).
		/// </summary>
			...
			int segmentClusterID )
		{
				...
				CustomSqlHelper.CreateInputParameter("SegmentClusterID", SqlDbType.Int, null, false, segmentClusterID)))
			{
				...
				{
					CustomGenericList<SegmentCluster> list = helper.ExecuteReader(command);
					if (list.Count > 0)
					{
		...
		public CustomGenericList<CustomDataRow> SegmentClusterSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int segmentClusterID)
		{
		...
		/// <summary>
		/// Insert values into SegmentCluster.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Insert values into SegmentCluster. Returns an object of type SegmentCluster.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from SegmentCluster by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="segmentClusterID"></param>
		...
		/// <summary>
		/// Update values in SegmentCluster. Returns an object of type SegmentCluster.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="segmentClusterID"></param>
		...
		/// <summary>
		/// Manage SegmentCluster object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in SegmentCluster.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type SegmentCluster.</param>
