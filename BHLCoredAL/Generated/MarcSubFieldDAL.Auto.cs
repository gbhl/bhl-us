...
namespace MOBOT.BHL.DAL
{
	partial class MarcSubFieldDAL 
	{
		...
		public MarcSubField MarcSubFieldSelectAuto(
			...
			int marcSubFieldID)
		{
			return MarcSubFieldSelectAuto(	sqlConnection, sqlTransaction, "BHL",	marcSubFieldID );
		}
		...
		public CustomGenericList<CustomDataRow> MarcSubFieldSelectAutoRaw(
			...
			int marcSubFieldID)
		{
			return MarcSubFieldSelectAutoRaw( sqlConnection, sqlTransaction, "BHL", marcSubFieldID );
		}
		...
		public MarcSubField MarcSubFieldInsertAuto(
			...
			string value)
		{
			return MarcSubFieldInsertAuto( sqlConnection, sqlTransaction, "BHL", marcDataFieldID, code, value );
		}
		...
		public MarcSubField MarcSubFieldInsertAuto(
			...
			MarcSubField value)
		{
			return MarcSubFieldInsertAuto(sqlConnection, sqlTransaction, "BHL", value);
		}
		...
		public bool MarcSubFieldDeleteAuto(
			...
			int marcSubFieldID)
		{
			return MarcSubFieldDeleteAuto( sqlConnection, sqlTransaction, "BHL", marcSubFieldID );
		}
		...
		public MarcSubField MarcSubFieldUpdateAuto(
			...
			string value)
		{
			return MarcSubFieldUpdateAuto( sqlConnection, sqlTransaction, "BHL", marcSubFieldID, marcDataFieldID, code, value);
		}
