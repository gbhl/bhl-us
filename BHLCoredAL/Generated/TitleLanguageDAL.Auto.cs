...
// This partial class TitleLanguageDAL is based upon TitleLanguage.
...
namespace MOBOT.BHL.DAL
{
	partial class TitleLanguageDAL 
	{
		...
		/// <summary>
		/// Select values from TitleLanguage by primary key(s).
		/// </summary>
		...
		public CustomGenericList<CustomDataRow> TitleLanguageSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int titleLanguageID)
		{
		...
		/// <summary>
		/// Insert values into TitleLanguage.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Insert values into TitleLanguage. Returns an object of type TitleLanguage.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Manage TitleLanguage object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in TitleLanguage.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type TitleLanguage.</param>
