...
// This partial class AuthorRoleDAL is based upon AuthorRole.
...
namespace MOBOT.BHL.DAL
{
	partial class AuthorRoleDAL 
	{
		...
		/// <summary>
		/// Select values from AuthorRole by primary key(s).
		/// </summary>
		...
		public CustomGenericList<CustomDataRow> AuthorRoleSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int authorRoleID)
		{
		...
		/// <summary>
		/// Insert values into AuthorRole. Returns an object of type AuthorRole.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from AuthorRole by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="authorRoleID"></param>
		...
		/// <summary>
		/// Update values in AuthorRole. Returns an object of type AuthorRole.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="authorRoleID"></param>
		...
		/// <summary>
		/// Manage AuthorRole object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in AuthorRole.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type AuthorRole.</param>
