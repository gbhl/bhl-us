...
namespace MOBOT.BHL.DAL
{
	partial class ItemCollectionDAL : IItemCollectionDAL
	{
 		#region ===== SELECT =====
		...
		{
			return ItemCollectionSelectAuto(	sqlConnection, sqlTransaction, "BHL",	itemCollectionID );
		}
			...
			int itemCollectionID )
		{
			...
			using (SqlCommand command = CustomSqlHelper.CreateCommand("ItemCollectionSelectAuto", connection, transaction, 
				CustomSqlHelper.CreateInputParameter("ItemCollectionID", SqlDbType.Int, null, false, itemCollectionID)))
			{
		...
		public CustomGenericList<CustomDataRow> ItemCollectionSelectAutoRaw(
			...
			int itemCollectionID)
		{
			return ItemCollectionSelectAutoRaw( sqlConnection, sqlTransaction, "BHL", itemCollectionID );
		}
		...
		public ItemCollection ItemCollectionInsertAuto(
			...
			int collectionID)
		{
			return ItemCollectionInsertAuto( sqlConnection, sqlTransaction, "BHL", itemID, collectionID );
		}
			...
			int collectionID)
		{
			...
			using (SqlCommand command = CustomSqlHelper.CreateCommand("ItemCollectionInsertAuto", connection, transaction, 
				CustomSqlHelper.CreateOutputParameter("ItemCollectionID", SqlDbType.Int, null, false),
		...
		{
			return ItemCollectionInsertAuto(sqlConnection, sqlTransaction, "BHL", value);
		}
		...
		public bool ItemCollectionDeleteAuto(
			...
			int itemCollectionID)
		{
			return ItemCollectionDeleteAuto( sqlConnection, sqlTransaction, "BHL", itemCollectionID );
		}
		...
		public ItemCollection ItemCollectionUpdateAuto(
			...
			int collectionID)
		{
			return ItemCollectionUpdateAuto( sqlConnection, sqlTransaction, "BHL", itemCollectionID, itemID, collectionID);
		}
		...
		public ItemCollection ItemCollectionUpdateAuto(
			...
			ItemCollection value)
		{
			return ItemCollectionUpdateAuto(sqlConnection, sqlTransaction, "BHL", value );
		}
		...
		public CustomDataAccessStatus<ItemCollection> ItemCollectionManageAuto(
			...
			ItemCollection value  )
		{
			return ItemCollectionManageAuto( sqlConnection, sqlTransaction, "BHL", value  );
		}
