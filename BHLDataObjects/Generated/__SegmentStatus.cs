...
// This abstract class __SegmentStatus is based upon SegmentStatus.
...
{	
	[Serializable]
	public abstract class __SegmentStatus : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		#region Constructors
		...
		public __SegmentStatus(int segmentStatusID, 
			string statusName, 
		...
		/// DBMS data type: int;
		/// </summary>
		[ColumnDefinition("SegmentStatusID", DbTargetType=SqlDbType.Int, Ordinal=1, NumericPrecision=10, IsInForeignKey=true, IsInPrimaryKey=true)]
		...
		/// <summary>
		/// Deserializes the byte array and returns an instance of <see cref="__SegmentStatus"/>.
		/// </summary>
		/// <returns>If the byte array can be deserialized and cast to an instance of <see cref="__SegmentStatus"/>, 
		/// returns an instance of <see cref="__SegmentStatus"/>; otherwise returns null.</returns>
		public static new __SegmentStatus FromArray(byte[] byteArray)
		{
			__SegmentStatus o = null;
			
			try
			{
				o = (__SegmentStatus) CustomObjectBase.FromArray(byteArray);
			}
			catch (Exception e)
			{
				throw e;
		...
		/// <summary>
		/// Compares this instance with a specified object. Throws an ArgumentException if the specified object is not of type <see cref="__SegmentStatus"/>.
		/// </summary>
		/// <param name="obj">An <see cref="__SegmentStatus"/> object to compare with this instance.</param>
		/// <returns>0 if the specified object equals this instance; -1 if the specified object does not equal this instance.</returns>
		public virtual int CompareTo(Object obj)
		{
			if (obj is __SegmentStatus)
			{
				__SegmentStatus o = (__SegmentStatus) obj;
			...
			{
				throw new ArgumentException("Argument is not of type __SegmentStatus");
			}
		}
		...
		/// </summary>
		/// <param name="a">The first <see cref="__SegmentStatus"/> object to compare.</param>
		/// <param name="b">The second <see cref="__SegmentStatus"/> object to compare.</param>
		/// <returns>true if values of operands are equal, false otherwise.</returns>
		public static bool operator == (__SegmentStatus a, __SegmentStatus b)
		{
		...
		/// </summary>
		/// <param name="obj">The <see cref="__SegmentStatus"/> object to compare with the current <see cref="__SegmentStatus"/>.</param>
		...
		public override bool Equals(Object obj)
		{
			...
			return this == (__SegmentStatus) obj;
		}
		...
		/// list.Sort(SortOrder.Ascending, __SegmentStatus.SortColumn.SegmentStatusID);
		/// </summary>
		[Serializable]
