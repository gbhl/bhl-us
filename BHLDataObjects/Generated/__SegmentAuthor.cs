...
// This abstract class __SegmentAuthor is based upon SegmentAuthor.
...
{	
	[Serializable]
	public abstract class __SegmentAuthor : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		#region Constructors
		...
		public __SegmentAuthor(int segmentAuthorID, 
			int segmentID, 
			int authorID, 
			short sequenceOrder, 
		...
		/// <summary>
		/// Deserializes the byte array and returns an instance of <see cref="__SegmentAuthor"/>.
		/// </summary>
		/// <returns>If the byte array can be deserialized and cast to an instance of <see cref="__SegmentAuthor"/>, 
		/// returns an instance of <see cref="__SegmentAuthor"/>; otherwise returns null.</returns>
		public static new __SegmentAuthor FromArray(byte[] byteArray)
		{
			__SegmentAuthor o = null;
			
			try
			{
				o = (__SegmentAuthor) CustomObjectBase.FromArray(byteArray);
			}
			catch (Exception e)
			{
				throw e;
		...
		/// <summary>
		/// Compares this instance with a specified object. Throws an ArgumentException if the specified object is not of type <see cref="__SegmentAuthor"/>.
		/// </summary>
		/// <param name="obj">An <see cref="__SegmentAuthor"/> object to compare with this instance.</param>
		/// <returns>0 if the specified object equals this instance; -1 if the specified object does not equal this instance.</returns>
		public virtual int CompareTo(Object obj)
		{
			if (obj is __SegmentAuthor)
			{
				__SegmentAuthor o = (__SegmentAuthor) obj;
			...
			{
				throw new ArgumentException("Argument is not of type __SegmentAuthor");
			}
		}
		...
		/// </summary>
		/// <param name="a">The first <see cref="__SegmentAuthor"/> object to compare.</param>
		/// <param name="b">The second <see cref="__SegmentAuthor"/> object to compare.</param>
		/// <returns>true if values of operands are equal, false otherwise.</returns>
		public static bool operator == (__SegmentAuthor a, __SegmentAuthor b)
		{
		...
		/// </summary>
		/// <param name="obj">The <see cref="__SegmentAuthor"/> object to compare with the current <see cref="__SegmentAuthor"/>.</param>
		...
		public override bool Equals(Object obj)
		{
			...
			return this == (__SegmentAuthor) obj;
		}
		...
		/// list.Sort(SortOrder.Ascending, __SegmentAuthor.SortColumn.SegmentAuthorID);
		/// </summary>
		[Serializable]
