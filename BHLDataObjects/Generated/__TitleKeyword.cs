...
{	
	...
	public abstract class __TitleKeyword : CustomObjectBase, ICloneable, IComparable, IDisposable, ISetValues
	{
		...
		public __TitleKeyword(int titleKeywordID, 
			int titleID, 
			int keywordID, 
		...
		{
			_TitleKeywordID = titleKeywordID;
			TitleID = titleID;
			KeywordID = keywordID;
		...
		public virtual void SetValues(CustomDataRow row)
		{
			foreach (CustomDataColumn column in row)
			{
				switch (column.Name)
				{
					case "TitleKeywordID" :
					{
						_TitleKeywordID = (int)column.Value;
						break;
					}
					case "TitleID" :
					{
		...
		private int _TitleKeywordID = default(int);
		
		/// <summary>
		/// Column: TitleKeywordID;
		/// DBMS data type: int; Auto key;
		/// </summary>
		[ColumnDefinition("TitleKeywordID", DbTargetType=SqlDbType.Int, Ordinal=1, NumericPrecision=10, IsAutoKey=true, IsInPrimaryKey=true)]
		public int TitleKeywordID
		{
			get
			{
				return _TitleKeywordID;
			}
			set
			{
		...
		/// </summary>
		[ColumnDefinition("MarcDataFieldTag", DbTargetType=SqlDbType.NVarChar, Ordinal=4, CharacterMaxLength=50, IsNullable=true)]
		...
		/// DBMS data type: nvarchar(50); Nullable;
		/// </summary>
		[ColumnDefinition("MarcSubFieldCode", DbTargetType=SqlDbType.NVarChar, Ordinal=5, CharacterMaxLength=50, IsNullable=true)]
		...
		/// <summary>
		/// Deserializes the byte array and returns an instance of <see cref="__TitleKeyword"/>.
		/// </summary>
		/// <returns>If the byte array can be deserialized and cast to an instance of <see cref="__TitleKeyword"/>, 
		/// returns an instance of <see cref="__TitleKeyword"/>; otherwise returns null.</returns>
		public static new __TitleKeyword FromArray(byte[] byteArray)
		{
			__TitleKeyword o = null;
			
			try
			{
				o = (__TitleKeyword) CustomObjectBase.FromArray(byteArray);
			}
			catch (Exception e)
			{
				throw e;
		...
		/// <summary>
		/// Compares this instance with a specified object. Throws an ArgumentException if the specified object is not of type <see cref="__TitleKeyword"/>.
		/// </summary>
		/// <param name="obj">An <see cref="__TitleKeyword"/> object to compare with this instance.</param>
		/// <returns>0 if the specified object equals this instance; -1 if the specified object does not equal this instance.</returns>
		public virtual int CompareTo(Object obj)
		{
			if (obj is __TitleKeyword)
			{
				__TitleKeyword o = (__TitleKeyword) obj;
				
				if (
					o.IsNew == IsNew &&
					o.IsDeleted == IsDeleted &&
					o.TitleKeywordID == TitleKeywordID &&
					o.TitleID == TitleID &&
			...
			{
				throw new ArgumentException("Argument is not of type __TitleKeyword");
			}
		}
		...
		/// </summary>
		/// <param name="a">The first <see cref="__TitleKeyword"/> object to compare.</param>
		/// <param name="b">The second <see cref="__TitleKeyword"/> object to compare.</param>
		/// <returns>true if values of operands are equal, false otherwise.</returns>
		public static bool operator == (__TitleKeyword a, __TitleKeyword b)
		{
		...
		/// </summary>
		/// <param name="obj">The <see cref="__TitleKeyword"/> object to compare with the current <see cref="__TitleKeyword"/>.</param>
		...
		public override bool Equals(Object obj)
		{
			...
			return this == (__TitleKeyword) obj;
		}
		...
		{	
			public const string TitleKeywordID = "TitleKeywordID";	
