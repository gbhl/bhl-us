CREATE TABLE [dbo].[BSSegment] (
	...
	[PublisherName]	              NVARCHAR (250)  CONSTRAINT [DF_BSSegment_Publisher] DEFAULT ('') NOT NULL,
	[PublisherPlace]              NVARCHAR (150)  CONSTRAINT [DF_BSSegment_PublisherPlace] DEFAULT ('') NOT NULL,
	...
	[OCLC]                        NVARCHAR (125)  CONSTRAINT [DF_BSSegment_OCLC] DEFAULT ('') NOT NULL,
	[JSTOR]                       NVARCHAR (125)  CONSTRAINT [DF_BSSegment_JSTOR] DEFAULT ('') NOT NULL,
