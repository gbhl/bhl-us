...
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\ItemSelectForPublishToProduction.sql"
...
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\OAIHarvestLogSelectWithNewRecords.sql"
