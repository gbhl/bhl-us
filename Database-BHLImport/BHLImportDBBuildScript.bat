...
sqlcmd -E -S %1 -d %2 -i "dbo\Synonyms\BHLSegmentAuthor.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Synonyms\BHLSegmentGenre.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Synonyms\BHLSegmentIdentifier.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Synonyms\BHLSegmentPage.sql"
...
REM --------------------------------------
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\BotanicusHarvestLogDeleteAuto.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\BotanicusHarvestLogInsertAuto.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\BotanicusHarvestLogSelectAuto.sql"
...
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\IAFileSelectByRemoteFileName.sql"
...
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\ItemFixProductionAssociatedTitles.sql"
...
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\StatsSelectIAItemPendingApprovalGroupByAge.sql"
...
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\Title_CreatorDeleteAuto.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\Title_CreatorInsertAuto.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\Title_CreatorSelectAuto.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\Title_CreatorSelectNewByKeyCreatorAndSource.sql"
sqlcmd -E -S %1 -d %2 -i "dbo\Stored Procedures\Title_CreatorUpdateAuto.sql"
