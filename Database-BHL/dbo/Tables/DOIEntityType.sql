...
GO
CREATE TRIGGER dbo.DOIEntityType_AuditBasic_Insert ON [dbo].[DOIEntityType]
 AFTER Insert
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.DOIEntityType', 'I',@UserSQL, Inserted.DOIEntityTypeID,NULL
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[DOIEntityType_AuditBasic_Insert]', @order = N'last', @stmttype = N'insert';


GO
CREATE TRIGGER dbo.DOIEntityType_AuditBasic_Update ON [dbo].[DOIEntityType]
 AFTER Update
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @IsDirty = 0
 ...
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.DOIEntityType', 'U',@UserSQL, Inserted.DOIEntityTypeID,NULL
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[DOIEntityType_AuditBasic_Update]', @order = N'last', @stmttype = N'update';


GO
CREATE TRIGGER dbo.DOIEntityType_AuditBasic_Delete ON [dbo].[DOIEntityType]
 AFTER Delete
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 BEGIN TRY 
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.DOIEntityType', 'D',@UserSQL, Deleted.DOIEntityTypeID,NULL 
 FROM Deleted 
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[DOIEntityType_AuditBasic_Delete]', @order = N'last', @stmttype = N'delete';
