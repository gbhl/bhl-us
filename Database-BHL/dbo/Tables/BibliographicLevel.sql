...
GO
CREATE TRIGGER dbo.BibliographicLevel_AuditBasic_Insert ON [dbo].[BibliographicLevel]
 AFTER Insert
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.BibliographicLevel', 'I',@UserSQL, Inserted.BibliographicLevelID,NULL
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[BibliographicLevel_AuditBasic_Insert]', @order = N'last', @stmttype = N'insert';


GO
CREATE TRIGGER dbo.BibliographicLevel_AuditBasic_Update ON [dbo].[BibliographicLevel]
 AFTER Update
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @IsDirty = 0
 ...
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.BibliographicLevel', 'U',@UserSQL, Inserted.BibliographicLevelID,NULL
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[BibliographicLevel_AuditBasic_Update]', @order = N'last', @stmttype = N'update';


GO
CREATE TRIGGER dbo.BibliographicLevel_AuditBasic_Delete ON [dbo].[BibliographicLevel]
 AFTER Delete
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 BEGIN TRY 
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.BibliographicLevel', 'D',@UserSQL, Deleted.BibliographicLevelID,NULL 
 FROM Deleted 
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[BibliographicLevel_AuditBasic_Delete]', @order = N'last', @stmttype = N'delete';
