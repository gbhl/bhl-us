...
GO
CREATE TRIGGER dbo.ItemCollection_AuditBasic_Insert ON [dbo].[ItemCollection]
 AFTER Insert
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.ItemCollection', 'I',@UserSQL, Inserted.ItemCollectionID,NULL
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[ItemCollection_AuditBasic_Insert]', @order = N'last', @stmttype = N'insert';


GO
CREATE TRIGGER dbo.ItemCollection_AuditBasic_Update ON [dbo].[ItemCollection]
 AFTER Update
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @IsDirty = 0
 ...
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.ItemCollection', 'U',@UserSQL, Inserted.ItemCollectionID,NULL
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[ItemCollection_AuditBasic_Update]', @order = N'last', @stmttype = N'update';


GO
CREATE TRIGGER dbo.ItemCollection_AuditBasic_Delete ON [dbo].[ItemCollection]
 AFTER Delete
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 BEGIN TRY 
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.ItemCollection', 'D',@UserSQL, Deleted.ItemCollectionID,NULL 
 FROM Deleted 
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[ItemCollection_AuditBasic_Delete]', @order = N'last', @stmttype = N'delete';
