...
GO
CREATE TRIGGER dbo.AuthorRole_AuditBasic_Insert ON [dbo].[AuthorRole]
 AFTER Insert
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.AuthorRole', 'I',@UserSQL, Inserted.AuthorRoleID,Inserted.CreationUserID
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[AuthorRole_AuditBasic_Insert]', @order = N'last', @stmttype = N'insert';


GO
CREATE TRIGGER dbo.AuthorRole_AuditBasic_Update ON [dbo].[AuthorRole]
 AFTER Update
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @IsDirty = 0
 ...
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.AuthorRole', 'U',@UserSQL, Inserted.AuthorRoleID,Inserted.LastModifiedUserID
 FROM Inserted
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[AuthorRole_AuditBasic_Update]', @order = N'last', @stmttype = N'update';


GO
CREATE TRIGGER dbo.AuthorRole_AuditBasic_Delete ON [dbo].[AuthorRole]
 AFTER Delete
 NOT FOR REPLICATION
 AS 
 BEGIN 
...
SET @AuditTime = GetDate()
 ...
 BEGIN TRY 
 INSERT audit.AuditBasic (AuditDate, SystemUserID, EntityName, Operation, SQLStatement, EntityKey1, ApplicationUserID)
 SELECT @AuditTime, SUSER_SNAME(), 'dbo.AuthorRole', 'D',@UserSQL, Deleted.AuthorRoleID,NULL 
 FROM Deleted 
 ...
 END 
GO
EXECUTE sp_settriggerorder @triggername = N'[dbo].[AuthorRole_AuditBasic_Delete]', @order = N'last', @stmttype = N'delete';
