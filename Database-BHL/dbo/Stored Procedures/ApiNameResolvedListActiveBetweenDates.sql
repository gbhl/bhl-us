...
CREATE PROCEDURE [dbo].[ApiNameResolvedListActiveBetweenDates]
...
WHERE	pn.CreationDate BETWEEN @StartDate AND @EndDate 
OR		pn.LastModifiedDate BETWEEN @StartDate AND @EndDate
GROUP BY
