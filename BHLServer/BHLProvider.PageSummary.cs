...
namespace MOBOT.BHL.Server
{
    public partial class BHLProvider
    {
        ...
        public PageSummaryView PageSummarySelectByItemId(int itemId, int? titleId)
        {
            List<PageSummaryView> list = new PageSummaryDAL().PageSummarySelectByItemId(null, null, itemId);
            if (list != null)
            {
        ...
        public PageSummaryView PageSummarySegmentSelectBySegmentID(int segmentID, int? titleID)
        {
            List<PageSummaryView> list = new PageSummaryDAL().PageSummarySegmentSelectBySegmentID(null, null, segmentID);
