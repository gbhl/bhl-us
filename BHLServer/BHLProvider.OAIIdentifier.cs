...
namespace MOBOT.BHL.Server
{
    public partial class BHLProvider
    {
        ...
        {
            return new OAIIdentifierDAL().OAIIdentifierSelectItems(null, null, maxIdentifiers, startId, fromDate, untilDate);
        }
        ...
        public CustomGenericList<OAIIdentifier> OAIIdentifierSelectSegments(int maxIdentifiers, int startId,
            DateTime? fromDate, DateTime? untilDate)
        {
            return new OAIIdentifierDAL().OAIIdentifierSelectSegments(null, null, maxIdentifiers, startId, fromDate, untilDate);
        }
