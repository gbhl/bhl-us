<%@ Page Title="Detailed OpenUrl Results" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="True" CodeBehind="OpenUrlResultDetail.aspx.cs" Inherits="MOBOT.BHL.AdminWeb.OpenUrlResultDetail" %>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px" valign="top" class="boxTable">
				<p>
					<span class="pageHeader">OpenUrl Search Result Details</span>
				</p>
				<hr />
