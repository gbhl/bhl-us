<%@ Page Title="User Stats" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="True" CodeBehind="WebStatsUser.aspx.cs" Inherits="MOBOT.BHL.AdminWeb.WebStatsUser" %>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px" valign="top" class="boxTable">
				<p>
					<span class="pageHeader">Top User Usage</span>
				</p>
				<hr />
				<br />
				...
				<asp:GridView ID="statsList" runat="server" AutoGenerateColumns="False" CssClass="boxTable" HeaderStyle-Wrap="false" CellPadding="3"
					GridLines="None" RowStyle-BackColor="white" AlternatingRowStyle-BackColor="#FFFFD7" Width="300px" AllowSorting="false" OnRowDataBound="gsList_RowDataBound">
					<Columns>
						<asp:TemplateField HeaderText="User" HeaderStyle-HorizontalAlign="Left" ItemStyle-Wrap="false">
							<ItemTemplate>
