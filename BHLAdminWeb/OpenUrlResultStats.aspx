<%@ Page Title="OpenUrl Result Stats" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="True" CodeBehind="OpenUrlResultStats.aspx.cs" Inherits="MOBOT.BHL.AdminWeb.OpenUrlResultStats" %>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px" valign="top" class="boxTable">
				<p>
					<span class="pageHeader">OpenUrl Search Results</span>
				</p>
				<hr />
				<br />
				...
				<asp:GridView ID="statsList" runat="server" AutoGenerateColumns="False" CssClass="boxTable" HeaderStyle-Wrap="false" CellPadding="3"
					GridLines="None" RowStyle-BackColor="white" AlternatingRowStyle-BackColor="#FFFFD7" AllowSorting="false" OnRowDataBound="gsList_RowDataBound">
					<Columns>
						<asp:BoundField HeaderText="Results" DataField="StringColumn01" ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Left" />
