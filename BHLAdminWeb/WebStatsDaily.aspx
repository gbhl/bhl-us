<%@ Page Title="Daily Stats" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="True" CodeBehind="WebStatsDaily.aspx.cs" Inherits="MOBOT.BHL.AdminWeb.WebStatsDaily" %>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px" valign="top" class="boxTable">
				<p>
					<span class="pageHeader">Daily Usage</span>
				</p>
				<hr />
				<br />
				...
				<asp:GridView ID="statsList" runat="server" AutoGenerateColumns="False" CssClass="boxTable" HeaderStyle-Wrap="false" CellPadding="3"
					...
					<Columns>
						<asp:BoundField HeaderText="Request Type" DataField="StringColumn01" ItemStyle-Wrap="false" HeaderStyle-HorizontalAlign="Left" />
