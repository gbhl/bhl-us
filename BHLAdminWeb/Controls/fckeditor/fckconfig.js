...
FCKConfig.ToolbarSets["BHL"] = [
	['Undo','Redo','Cut','Copy','Paste','PasteText','PasteWord','SpecialChar','-','Print'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Link','Unlink','Anchor','Table','Rule','PageBreak','TextColor','BGColor','FontName','FontSize'],
	'/',
