	...
	<div class="box" style="padding: 5px;margin-right:5px;width:600px">
		<table cellpadding="4px" width="100%">
			...
			<tr>
				...
				<td>
					<asp:TextBox ID="noteTypeNameTextBox" runat="server" MaxLength="50" Width="400"></asp:TextBox>
				</td>
			</tr>
			<tr>
				<td style="white-space: nowrap" align="right">
				...
				<td>
					<asp:TextBox ID="noteTypeDisplayTextBox" runat="server" MaxLength="50" Width="400"></asp:TextBox>
				</td>
			</tr>
			<tr>
				<td style="white-space: nowrap" align="right">
