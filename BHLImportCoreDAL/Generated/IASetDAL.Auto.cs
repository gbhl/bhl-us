...
// This partial class IASetDAL is based upon IASet.
...
namespace MOBOT.BHLImport.DAL
{
	partial class IASetDAL 
	{
		...
		/// <summary>
		/// Select values from IASet by primary key(s).
		/// </summary>
		...
		public CustomGenericList<CustomDataRow> IASetSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int setID)
		{
		...
		/// <summary>
		/// Insert values into IASet. Returns an object of type IASet.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from IASet by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="setID"></param>
		...
		/// <summary>
		/// Update values in IASet. Returns an object of type IASet.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="setID"></param>
		...
		/// then either insert values into, delete values from, or update values in IASet.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type IASet.</param>
