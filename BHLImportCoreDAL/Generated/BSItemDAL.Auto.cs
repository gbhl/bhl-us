...
// This partial class BSItemDAL is based upon dbo.BSItem.
...
namespace MOBOT.BHLImport.DAL
{
	partial class BSItemDAL 
	{
		...
		/// <summary>
		/// Select values from dbo.BSItem by primary key(s).
		/// </summary>
		...
		public List<CustomDataRow> BSItemSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int itemID)
		{
		...
		/// <summary>
		/// Insert values into dbo.BSItem. Returns an object of type BSItem.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from dbo.BSItem by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="itemID"></param>
		...
		/// <summary>
		/// Update values in dbo.BSItem. Returns an object of type BSItem.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="itemID"></param>
		...
		/// <summary>
		/// Manage dbo.BSItem object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in dbo.BSItem.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type BSItem.</param>
