...
// This partial class OAIRecordDCTypeDAL is based upon OAIRecordDCType.
...
namespace MOBOT.BHLImport.DAL
{
	partial class OAIRecordDCTypeDAL 
	{
		...
		/// <summary>
		/// Select values from OAIRecordDCType by primary key(s).
		/// </summary>
			...
			int oAIRecordDCTypeID )
		{
				...
				CustomSqlHelper.CreateInputParameter("OAIRecordDCTypeID", SqlDbType.Int, null, false, oAIRecordDCTypeID)))
			{
				...
				{
					CustomGenericList<OAIRecordDCType> list = helper.ExecuteReader(command);
					if (list.Count > 0)
					{
		...
		public CustomGenericList<CustomDataRow> OAIRecordDCTypeSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int oAIRecordDCTypeID)
		{
		...
		/// <summary>
		/// Insert values into OAIRecordDCType.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Insert values into OAIRecordDCType. Returns an object of type OAIRecordDCType.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from OAIRecordDCType by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="oAIRecordDCTypeID"></param>
		...
		/// <summary>
		/// Update values in OAIRecordDCType. Returns an object of type OAIRecordDCType.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="oAIRecordDCTypeID"></param>
		...
		/// <summary>
		/// Manage OAIRecordDCType object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in OAIRecordDCType.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type OAIRecordDCType.</param>
