...
// This partial class OAIRecordRightDAL is based upon OAIRecordRight.
...
namespace MOBOT.BHLImport.DAL
{
	partial class OAIRecordRightDAL 
	{
		...
		/// <summary>
		/// Select values from OAIRecordRight by primary key(s).
		/// </summary>
			...
			int oAIRecordRightID )
		{
				...
				CustomSqlHelper.CreateInputParameter("OAIRecordRightID", SqlDbType.Int, null, false, oAIRecordRightID)))
			{
				...
				{
					CustomGenericList<OAIRecordRight> list = helper.ExecuteReader(command);
					if (list.Count > 0)
					{
		...
		public CustomGenericList<CustomDataRow> OAIRecordRightSelectAutoRaw(
			SqlConnection sqlConnection, 
			SqlTransaction sqlTransaction, 
			int oAIRecordRightID)
		{
		...
		/// <summary>
		/// Insert values into OAIRecordRight.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Insert values into OAIRecordRight. Returns an object of type OAIRecordRight.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		...
		/// <summary>
		/// Delete values from OAIRecordRight by primary key(s).
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="oAIRecordRightID"></param>
		...
		/// <summary>
		/// Update values in OAIRecordRight. Returns an object of type OAIRecordRight.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="oAIRecordRightID"></param>
		...
		/// <summary>
		/// Manage OAIRecordRight object.
		/// If the object is of type CustomObjectBase, 
		/// then either insert values into, delete values from, or update values in OAIRecordRight.
		/// </summary>
		/// <param name="sqlConnection">Sql connection or null.</param>
		/// <param name="sqlTransaction">Sql transaction or null.</param>
		/// <param name="value">Object of type OAIRecordRight.</param>
