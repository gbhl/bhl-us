...
//<![CDATA[
    ...
    $(document).ready(function () {
            ...
            if (pages != null) {
                ...
                if (pages[index].ExternalBaseUrl.includes("archive.org")) {
                    ...
                    if (calculatedWidth < 150) {
                        fileSize = "thumb";
                    } else if (calculatedWidth < 235) {
                        fileSize = "small";
                    } else if (calculatedWidth < 465) {
                        fileSize = "medium";
                    } else if (calculatedWidth < 930) {
                        fileSize = "large";
                    }
        ...
        if (!$('html').is('.ie6')) {
            ...
            if (!<%=System.Configuration.ConfigurationManager.AppSettings["SearchProviders"].ToLower().Contains("bhl.search.elastic").ToString().ToLower()%>) $("#showSearchButton").hide();
