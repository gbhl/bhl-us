                        ...
                        <div class="body form">
                            ...
                            <div class="success">
                                ...
                                <div style="float:left;margin:0;width:49%">
                                    ...
                                    <a class="featurebutton-home" title="Subscribe to BHL Newsletter" rel="noopener noreferrer" target="_blank" href="<%=MOBOT.BHL.Web.Utilities.AppConfig.NewsletterSignupUrl%>">Subscribe</a>
                                </div>
                                <div style="float:left;margin:0;width:49%">
                                    <h3>Help Support <span>BHL</span></h3>
                                    <p>BHL relies on donations to provide free PDF downloads and other services.  Help keep BHL free and open!</p>
                                    <a class="featurebutton-home" title="Donate" rel="noopener noreferrer" target="_blank" href="<%=MOBOT.BHL.Web.Utilities.AppConfig.DonateUrl%>">Donate</a>
                                </div>
                            </div>
                            <div class="failure">
...
<script type="text/javascript">
    ...
    cmArgs.init({
        ...
        <%: string.IsNullOrWhiteSpace(PublicationDetail.RequestedTitleID) ? "" : ", itid: " + PublicationDetail.RequestedTitleID.ToString() %>
    });
</script>
<script type="text/javascript">
//<![CDATA[
    ...
    $(document).ready(function () {
        ...
        if (!$('html').is('.ie6')) {
            ...
            if (!<%=MOBOT.BHL.Web.Utilities.AppConfig.UseElasticSearch().ToString().ToLower()%>) $("#showSearchButton").hide();
