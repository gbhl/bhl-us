...
<asp:Content ID="Content1" ContentPlaceHolderID="PageHeaderIncludesPlaceHolder" runat="server">
    ...
    <!--   <style type="text/css">
            ...
            fieldset ol { padding: 1em 1em 0em 1em; list-style: none; }*/
    ...
    <section class="search">
        <div id="tabs">
            ...
            <div id="divBookSearch">
                ...
                <li>
                <label class="caption">Subject:</label><asp:TextBox ID="txtBookSubject" runat="server" Width="200"></asp:TextBox>
                </li>
                <li>
                <label class="caption">Language:</label><label class="select"><asp:DropDownList ID="ddlBookLanguage" runat="server" DataTextField="LanguageName" DataValueField="LanguageCode"></asp:DropDownList></label>
                </li>
                <li>
                <label class="caption">Collection:</label><label class="select"><asp:DropDownList ID="ddlBookCollection" runat="server" DataTextField="CollectionName" DataValueField="CollectionID"></asp:DropDownList></label>
                </li>
                <!-- 
                <li>
                <label class="caption">&nbsp;</label><label id="lblBookError" class="ErrorText" style="display:none">Please specify Title or Author Last Name, or select a Collection.</label>
                </li>
                -->
                </ol>
                <!--</fieldset>-->
            ...
            <div id="divArticleSearch">
                ...
                <ol>
                <li>
                <label class="caption">Article/Chapter Title:</label><asp:TextBox ID="txtArticleTitle" runat="server" Width="400"></asp:TextBox>
                </li>
                <li>
                <label class="caption">Journal/Book Title:</label><asp:TextBox ID="txtJournalTitle" runat="server" Width="400"></asp:TextBox>
                </li>
                <li>
                <label class="caption">Author Last Name:</label><asp:TextBox ID="txtArticleAuthor" runat="server"></asp:TextBox>
                </li>
                <li>
                <label class="caption">Year:</label><asp:TextBox ID="txtArticleYear" runat="server"></asp:TextBox>
                <br />
                <label id="lblArticleYearError" class="ErrorText" style="display:none; margin-left: 150px; padding-top: 10px;"> Please specify a 4-digit Year.</label>
                </li>
                <!--
                <li>
                <label class="caption">&nbsp;</label><label id="lblArticleError" class="ErrorText" style="display:none">Please specify a Journal Title.</label>
                </li>
                -->
                </ol>
                <div style="margin-left: 152px;">
            ...
            <div id="divAuthorSearch">
                ...
                <ol>
                <li>
                <label class="caption">Author Last Name:</label><asp:TextBox ID="txtAuthorLastName" runat="server" Width="200"></asp:TextBox>
                </li>
                <li>
                <label class="caption">Author First Name:</label><asp:TextBox ID="txtAuthorFirstName" runat="server" Width="200"></asp:TextBox>
                </li>
                <div style="background: #E6ECF1; border-radius: 5px; -webkit-border-radius: 5px; padding: 10px 0 17px; margin: 10px;">
                <li style="margin: 0px;">
                <label class="caption">- or -</label><label>&nbsp;</label>
                </li>
                <li>
                <label class="caption">Corporate/Meeting Name:</label><asp:TextBox ID="txtAuthorCorporateName" runat="server" Width="370" style="width: 370px !important"></asp:TextBox>
                </li>
                <!--
                <li>
                <label class="caption">&nbsp;</label><label id="lblAuthorError" class="ErrorText" style="display:none">Please specify Author Last Name or Corporate/Meeting Name.</label>
                </li>
                -->
                </div>
                </ol>
            ...
            <div id="divSubjectSearch">
                ...
                <li>
                <label class="caption">Subject:</label><asp:TextBox ID="txtSubject" runat="server" Width="200" class="inlinetextbox"></asp:TextBox>
                ...
                <!--
                <li>
                <label class="caption">&nbsp;</label><label id="lblSubjectError" class="ErrorText" style="display:none">Please specify a Subject.</label>
                </li>
                -->
                </ol>
                <!--</fieldset>-->
            ...
            <div id="divNameSearch">
                ...
                <ol style="margin-bottom: 50px;">
                <li>
                <label class="caption">Scientific Name:</label><asp:TextBox ID="txtName" runat="server" Width="250" class="inlinetextbox"></asp:TextBox>&nbsp;<asp:Button runat="server" ID="btnSearchName" Text="Search" onclick="btnSearchName_Click" class="inlinebutton" />
                </li>
                <!--
                <li>
                <label class="caption">&nbsp;</label><label id="lblNameError" class="ErrorText" style="display:none">Please specify a Name.</label>
                </li>
                -->
                </ol>
