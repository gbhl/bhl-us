...
BookReader.prototype.init = function () {
    ...
    if ($('#BRcontainer').attr('clientWidth') == 0 || $('#BRcontainer').attr('clientHeight') == 0) {
...
BookReader.prototype.onePageGetAutofitWidth = function () {
    //var widthPadding = 20;
    return (this.getMedianPageSize().width + 0.0) / ($('#BRcontainer').attr('clientWidth') - this.padding); //widthPadding * 2);
}

BookReader.prototype.onePageGetAutofitHeight = function () {    
    return (this.getMedianPageSize().height + 0.0) / ($('#BRcontainer').attr('clientHeight') - this.padding); // make sure a little of adjacent pages show
}
...
BookReader.prototype.prepareFlipLeftToRight = function(prevL, prevR) {
    ...
    //this.add2upPageToolBox(prevL, leftPage);
    ...
    //this.add2upPageToolBox(prevR, rightPage);
}
...
BookReader.prototype.prepareFlipRightToLeft = function (nextL, nextR) {
    ...
    //this.add2upPageToolBox(nextR, rightPage);
    ...
    //this.add2upPageToolBox(nextL, leftPage);
}
...
BookReader.prototype.updateNavPageNum = function (index) {
    ...
    //scs added
    //update page list
    $('#lstPages').attr("selectedIndex", index);
    //update names
    try {
        //  $(window).updatePageInfo(index);
        // $("#currentpageURL").text("http://biodiversitylibrary.org/page/" + this.bhlPageID(index));
