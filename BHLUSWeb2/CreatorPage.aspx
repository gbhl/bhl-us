<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreatorPage.aspx.cs" Inherits="MOBOT.BHL.Web2.CreatorPage" %>
...
<div id="browseContainerDiv">
    ...
    <span>Sort By:</span> 
        <ul>
        <li class="<%= SetSortClass("title") %>"><a href="/creator/<%= Author.AuthorID %>/title">Title</a></li>
        <li class="<%= SetSortClass("author") %>"><a href="/creator/<%= Author.AuthorID %>/author">Author</a></li>
        <li class="<%= SetSortClass("year") %>"><a href="/creator/<%= Author.AuthorID %>/year">Year</a></li>
        </ul>
